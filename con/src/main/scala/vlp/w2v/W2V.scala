...
object W2V {
  def main(args: Array[String]): Unit = {
    val path = "/Users/phuonglh/Downloads/c4-train.00000-of-01024-30K.json"
    ...
    val w2v = new Word2Vec().setInputCol("tokens").setOutputCol("result").setVectorSize(10).setMinCount(3)
