...
# ╔═╡ 1c37bb8a-1037-11f0-0ba1-d506954cb6ee
using TSne, Statistics, MLDatasets

# ╔═╡ c27aefa9-73e8-41c3-aed8-c61b96d39a91
using ImageView, ImageShow, ImageIO

# ╔═╡ 7d85110e-87a7-4028-bbdc-8d4a4aa7d373
using Plots

# ╔═╡ ed115acd-45eb-4b13-88f4-2e970b4b8ac3
rescale(A; dims=1) = (A .- mean(A, dims=dims)) ./ max.(std(A, dims=dims), eps())

# ╔═╡ 65541a4c-656d-43d7-a32d-dc453ec47183
X, Y = MNIST(split=:train)[:]

# ╔═╡ 42340f1a-6d1d-4c1a-a936-6a830659df0c
X[:,:,1]

# ╔═╡ 91411e0b-6560-4741-867a-05a008a1df7e
Y[1]

# ╔═╡ 671368c0-c0ae-4f8e-907b-8029dca8f7df
x = convert2image(MNIST, X[:,:,1])

# ╔═╡ 41ae71c1-7d52-4991-9707-5dcf1bb0eec5
data = reshape(permutedims(X[:, :, 1:2500], (3, 1, 2)), 2500, size(X, 1)*size(X,2));

# ╔═╡ a978132c-b9aa-4c83-b0a4-97faa7252d75
A = rescale(data, dims=1)

# ╔═╡ 1e9a9ca7-1988-4b3b-a89e-a2ddfa465a7b
# ╠═╡ disabled = true
#=╠═╡
using Plots
  ╠═╡ =#

# ╔═╡ e32460f0-c988-45b0-982c-763de7f6099e
T = tsne(A, 2, 50, 1000, 20.0)

# ╔═╡ 8a1abd40-7a3e-499e-b267-1c214374d662
size(T,1)
...
git-tree-sha1 = "f26113251c79a044870bde708bc0f551810bf8c9"
...
[[KernelAbstractions]]
deps = ["Adapt", "Atomix", "EnzymeCore", "InteractiveUtils", "LinearAlgebra", "MacroTools", "PrecompileTools", "Requires", "SparseArrays", "StaticArrays", "UUIDs"]
