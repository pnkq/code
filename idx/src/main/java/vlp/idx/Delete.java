 ...
 */
public class Delete {
  static final String URL = "http://112.137.134.8:9200/";
  ...
  public static void main(String[] args) throws Exception {
    ...
    RestHighLevelClient client = new RestHighLevelClient(RestClient.builder(new HttpHost("112.137.134.8", 9200, "http")));
