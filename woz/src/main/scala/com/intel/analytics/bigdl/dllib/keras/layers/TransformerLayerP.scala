...
/**
 * [[TransformerLayerP]] A self attention Keras-style layer. This is a modified version by PhuongLH of the original [[TransformerLayer]].
 *
 ...
 */
class TransformerLayerP[T: ClassTag](
  val nBlock: Int,
...
object TransformerLayerP {
  ...
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    nHead: Int = 12,
    hiddenSize: Int = 768,
    ffnSize: Int = 128, // added by PhuongLH
    embeddingDrop: Double = 0,
    initializerRange: Double = 0.02,
    bidirectional: Boolean = false,
    outputAllBlock: Boolean = false)(implicit ev: TensorNumeric[T]): TransformerLayerP[T] = {
    ...
    new TransformerLayerP[T](nBlock, residPdrop, attnPdrop, nHead,
      initializerRange, bidirectional, outputAllBlock,
      embeddingLayer.asInstanceOf[KerasLayer[Activity, Tensor[T], T]], ffnSize)
  }

  /**
   * [[TransformerLayerP]] A self attention keras like layer
   * @param nBlock block number
  ...
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    (implicit ev: TensorNumeric[T]): TransformerLayerP[T] = {
    new TransformerLayerP[T](nBlock, residPdrop, attnPdrop, nHead,
